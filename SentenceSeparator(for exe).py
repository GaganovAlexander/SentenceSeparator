...
if __name__ == '__main__':
    file_path = input('Введите путь до файла .txt, который хотите отформатировать:\n')
    with open(file_path[:-4]+' separated.txt', 'w', encoding='utf-8') as f:
        for i in sentence_separator(file_path):
            f.write(i + '\n')
    print('Готово! Введите любую клавишу...')
    input()
